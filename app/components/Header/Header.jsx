              ...
              return (
                <Button
                  ...
                  sx={{
                    ...
                    borderBottom: isActive ? `2px solid ${theme.primary.main}` : 'none',
            ...
            {isAdmin && (
              <Button
                ...
                sx={{
                  ...
                  color: pathname.startsWith('/admin') ? theme.primary.main : theme.text.secondary,
                  borderBottom: pathname.startsWith('/admin') ? `2px solid ${theme.primary.main}` : 'none',
                  borderRadius: '4px 4px 0 0',
                  px: 2,
                  py: 1,
                  textTransform: 'none',
