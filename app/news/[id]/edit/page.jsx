...
export default function EditNewsPage() {
  ...
  // Cargar datos de la noticia al montar el componente
  useEffect(() => {
    if (params.id) {
      fetchNewsData();
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await newsEndpoints.updateNews(params.id, newsData);
      showAlert('Noticia actualizada exitosamente');
      
      // Redirigir a la vista de detalle de la noticia después de un breve delay
      setTimeout(() => {
