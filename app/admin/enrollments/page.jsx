...
const EnrollmentsPage = () => {
    ...
    const fetchEnrollments = async () => {
        try {
            ...
            setError('Error al cargar las inscripciones: ' + (err.message || 'Error desconocido'));
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleStatusChange = async () => {
        ...
        try {
            ...
            setStatusError(null);
            await enrollmentEndpoints.updateEnrollmentStatus(selectedEnrollment.id, status);
    ...
    const columns = [
        ...
        { 
            ...
            valueFormatter: (value) => {
                return value ? format(new Date(value), 'yyyy-MM-dd HH:mm') : 'No disponible'
            }
        },
        ...
        { 
            ...
            width: 180,
            valueFormatter: (value) => value ? format(new Date(value), 'yyyy-MM-dd HH:mm') : 'No disponible'
        },
    ];
    ...
    const handleDownloadReceipt = (enrollment) => {
        ...
        console.log('Descargando comprobante para:', enrollment);
    };
