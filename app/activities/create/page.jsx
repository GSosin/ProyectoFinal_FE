      ...
      <Container maxWidth="md" sx={{ py: 4 }}>
        ...
        <Dialog open={openCategoryManager} onClose={() => setOpenCategoryManager(false)} maxWidth="sm" fullWidth>
          ...
          <DialogContent>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <CustomAlert 
                  message={categoryManagerError}
                  onClose={() => setCategoryManagerError(null)}
                  open={!!categoryManagerError}
              />
        ...
        <Dialog open={!!deleteCategoryId} onClose={() => setDeleteCategoryId(null)}>
          ...
          <DialogContent>
            ...
            <CustomAlert 
                ...
                onClose={() => setDeleteCategoryError(null)}
                open={!!deleteCategoryError}
            />
          </DialogContent>
          <DialogActions>
        ...
        <Dialog open={openLocationManager} onClose={() => setOpenLocationManager(false)} maxWidth="sm" fullWidth>
          ...
          <DialogContent>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <CustomAlert 
                  message={locationManagerError}
                  onClose={() => setLocationManagerError(null)}
                  open={!!locationManagerError}
              />
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                {locations.map((loc) => (
        ...
        <Dialog open={!!deleteLocationId} onClose={() => setDeleteLocationId(null)}>
          ...
          <DialogContent>
            ...
            <CustomAlert 
                message={deleteLocationError}
                onClose={() => setDeleteLocationError(null)}
                open={!!deleteLocationError}
            />
          </DialogContent>
          <DialogActions>
